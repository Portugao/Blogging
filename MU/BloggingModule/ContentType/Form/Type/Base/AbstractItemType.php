...
abstract class AbstractItemType extends AbstractContentFormType
{
    ...
    public function addIdField(FormBuilderInterface $builder, array $options = [])
    {
        ...
        $builder->add('id', ChoiceType::class, [
            ...
            'choices' => $choices,
            'required' => true,
            'label' => $this->__('Entry to display', 'mubloggingmodule') . ':'
        ]);
    }
    ...
    public function addDisplayModeField(FormBuilderInterface $builder, array $options = [])
    {
        $builder->add('displayMode', ChoiceType::class, [
            'label' => $this->__('Display mode', 'mubloggingmodule') . ':',
            'label_attr' => [
                'class' => 'radio-inline'
            ],
            'empty_data' => 'embed',
            'choices' => [
                $this->__('Link to object', 'mubloggingmodule') => 'link',
                $this->__('Embed object display', 'mubloggingmodule') => 'embed'
            ],
            'multiple' => false,
            'expanded' => true
        ]);
    ...
    public function addTemplateField(FormBuilderInterface $builder, array $options = [])
    {
        $builder
            ->add('customTemplate', TextType::class, [
                ...
                'attr' => [
                    'maxlength' => 80,
                    'title' => $this->__('Example', 'mubloggingmodule') . ': displaySpecial.html.twig'
                ],
                'help' => [
                    $this->__('Example', 'mubloggingmodule') . ': <em>displaySpecial.html.twig</em>',
                    $this->__('Needs to be located in the "External/YourEntity/" directory.', 'mubloggingmodule')
                ]
            ])
        ;
    }
    ...
    {
        return 'mubloggingmodule_contenttype_detail';
    }
