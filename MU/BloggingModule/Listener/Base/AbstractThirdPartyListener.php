...
abstract class AbstractThirdPartyListener implements EventSubscriberInterface
{
    ...
    public function contentGetTypes(\Zikula_Event $event)
    {
        ...
        $types->add('MUBloggingModule_ContentType_Item');
        
        // plugin for showing a list of multiple items
        $types->add('MUBloggingModule_ContentType_ItemList');
    }
    ...
    public function getEditorHelpers(EditorHelperEvent $event)
    {
        ...
        $event->getHelperCollection()->add(
            [
                ...
                'type' => 'javascript',
                'path' => $this->request->getBasePath() . '/web/modules/mublogging/js/MUBloggingModule.Finder.js'
            ]
        );
    }
    ...
    public function getCKEditorPlugins(GenericEvent $event)
    {
        $event->getSubject()->add([
            ...
            'path' => $this->request->getBasePath() . '/web/modules/mublogging/scribite/CKEditor/mubloggingmodule/',
            'file' => 'plugin.js',
    ...
    public function getQuillPlugins(GenericEvent $event)
    {
        $event->getSubject()->add([
            'name' => 'mubloggingmodule',
            'path' => $this->request->getBasePath() . '/web/modules/mublogging/scribite/Quill/mubloggingmodule/plugin.js'
        ]);
    }
    ...
    public function getSummernotePlugins(GenericEvent $event)
    {
        $event->getSubject()->add([
            'name' => 'mubloggingmodule',
            'path' => $this->request->getBasePath() . '/web/modules/mublogging/scribite/Summernote/mubloggingmodule/plugin.js'
        ]);
    }
    ...
    public function getTinyMcePlugins(GenericEvent $event)
    {
        $event->getSubject()->add([
            'name' => 'mubloggingmodule',
            'path' => $this->request->getBasePath() . '/web/modules/mublogging/scribite/TinyMce/mubloggingmodule/plugin.js'
        ]);
    }
}
