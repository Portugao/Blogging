...
namespace MU\BloggingModule\TaggedObjectMeta\Base;
 ...
 */
abstract class AbstractMUBloggingModule extends AbstractTaggedObjectMeta implements ContainerAwareInterface
{
    use ContainerAwareTrait;

    /**
     * MUBloggingModule constructor.
     *
    ...
    function __construct($objectId, $areaId, $module, $urlString = null, UrlInterface $urlObject = null)
    {
        ...
        $objectType = isset($urlArgs['ot']) ? $urlArgs['ot'] : 'post';
        ...
        $repository = $this->container->get('mu_blogging_module.entity_factory')->getRepository($objectType);
        $useJoins = false;
