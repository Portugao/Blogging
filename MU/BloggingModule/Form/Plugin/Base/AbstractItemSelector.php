...
namespace MU\BloggingModule\Form\Plugin\Base;
...
class AbstractItemSelector extends Zikula_Form_Plugin_TextInput implements ContainerAwareInterface
{
    ...
    public function render(Zikula_Form_View $view)
    {
        ...
        if ($firstTime) {
            ...
            $jsAssetBag->add($assetHelper->resolve('@MUBloggingModule:js/MUBloggingModule.js'));
            $jsAssetBag->add($assetHelper->resolve('@MUBloggingModule:js/MUBloggingModule.ItemSelector.js'));
        ...
        if (!$permissionApi->hasPermission('MUBloggingModule:' . ucfirst($this->objectType) . ':', '::', ACCESS_COMMENT)) {
            return false;
        }

        $categorisableObjectTypes = ['post'];
        $catIds = [];
        ...
        $view = Zikula_View::getInstance('MUBloggingModule', false);
    ...
    public function decode(Zikula_Form_View $view)
    {
        ...
        $this->objectType = $request->request->get('MUBloggingModule_objecttype', 'post');
