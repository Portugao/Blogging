...
/**
 * Image quick navigation form type base class.
 */
abstract class AbstractImageQuickNavType extends AbstractType
{
    use TranslatorTrait;
    ...
    * @param RequestStack        $requestStack RequestStack service instance
    ...
    {
        $listEntries = $this->listHelper->getEntries('image', 'workflowState');
        $choices = [];
        $choiceAttributes = [];
    ...
    {
        return 'mubloggingmodule_imagequicknav';
    }
}
