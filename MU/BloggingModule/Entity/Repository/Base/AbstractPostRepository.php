 ...
 *
 * This is the base repository class for post entities.
 */
abstract class AbstractPostRepository extends EntityRepository
{
     ...
     */
    protected $mainEntityClass = 'MU\BloggingModule\Entity\PostEntity';
    ...
    public function selectByIdList($idList = [0], $useJoins = true, $slimMode = false)
    {
        ...
        if (!$slimMode && null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('post', $qb);
        }
    ...
    protected function genericBaseQueryAddOrderBy(QueryBuilder $qb, $orderBy = '')
    {
        ...
        foreach (['imageForArticle'] as $uploadField) {
