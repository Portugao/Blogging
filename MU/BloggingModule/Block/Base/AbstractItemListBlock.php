...
abstract class AbstractItemListBlock extends AbstractBlockHandler
{
    ...
    {
        return $this->__('Blogging list', 'mubloggingmodule');
    }
    ...
    public function display(array $properties = [])
    {
        ...
        if (!$this->hasPermission('MUBloggingModule:ItemListBlock:', "$properties[title]::", ACCESS_OVERVIEW)) {
            return '';
        }
        ...
        if (empty($properties['title'])) {
            $properties['title'] = $this->__('Blogging list', 'mubloggingmodule');
        }
    ...
    {
        return '@MUBloggingModule/Block/itemlist_modify.html.twig';
    }
