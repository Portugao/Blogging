...
namespace MU\BloggingModule\ContentType\Form\Type\Base;
...
abstract class AbstractItemListType extends AbstractContentFormType
{
    ...
    public function addObjectTypeField(FormBuilderInterface $builder, array $options = [])
    {
        $builder->add('objectType', HiddenType::class, [
            'label' => $this->__('Object type', 'mubloggingmodule') . ':',
            'empty_data' => 'post'
        ]);
    }
    ...
    public function addCategoriesField(FormBuilderInterface $builder, array $options = [])
    {
        ...
        $builder->add('categories', CategoriesType::class, [
            'label' => ($hasMultiSelection ? $this->__('Categories', 'mubloggingmodule') : $this->__('Category', 'mubloggingmodule')) . ':',
            'empty_data' => $hasMultiSelection ? [] : null,
            'attr' => [
                'class' => 'category-selector',
                'title' => $this->__('This is an optional filter.', 'mubloggingmodule')
            ],
            'help' => $this->__('This is an optional filter.', 'mubloggingmodule'),
            'required' => false,
    ...
    public function addAmountField(FormBuilderInterface $builder, array $options = [])
    {
        $builder->add('amount', IntegerType::class, [
            'label' => $this->__('Amount', 'mubloggingmodule') . ':',
            'attr' => [
                'maxlength' => 2,
                'title' => $this->__('The maximum amount of items to be shown.', 'mubloggingmodule') . ' ' . $this->__('Only digits are allowed.', 'mubloggingmodule')
            ],
            'help' => $this->__('The maximum amount of items to be shown.', 'mubloggingmodule') . ' ' . $this->__('Only digits are allowed.', 'mubloggingmodule'),
            'empty_data' => 5,
            'scale' => 0
        ]);
    }
    ...
    public function addTemplateFields(FormBuilderInterface $builder, array $options = [])
    {
        $builder
            ->add('template', ChoiceType::class, [
                'label' => $this->__('Template', 'mubloggingmodule') . ':',
                'empty_data' => 'itemlist_display.html.twig',
                'choices' => [
                    $this->__('Only item titles', 'mubloggingmodule') => 'itemlist_display.html.twig',
                    $this->__('With description', 'mubloggingmodule') => 'itemlist_display_description.html.twig',
                    $this->__('Custom template', 'mubloggingmodule') => 'custom'
                ],
                'multiple' => false,
                'expanded' => false
            ])
            ->add('customTemplate', TextType::class, [
                'label' => $this->__('Custom template', 'mubloggingmodule') . ':',
                'required' => false,
                'attr' => [
                    'maxlength' => 80,
                    'title' => $this->__('Example', 'mubloggingmodule') . ': itemlist_[objectType]_display.html.twig'
                ],
                'help' => $this->__('Example', 'mubloggingmodule') . ': <em>itemlist_[objectType]_display.html.twig</em>'
            ])
        ;
    }
    ...
    public function addFilterField(FormBuilderInterface $builder, array $options = [])
    {
        $builder->add('filter', TextType::class, [
            'label' => $this->__('Filter (expert option)', 'mubloggingmodule') . ':',
            'required' => false,
            'attr' => [
                'maxlength' => 255,
                'title' => $this->__('Example', 'mubloggingmodule') . ': tbl.age >= 18'
            ],
            'help' => $this->__('Example', 'mubloggingmodule') . ': tbl.age >= 18'
        ]);
    }
    ...
    {
        return 'mubloggingmodule_contenttype_list';
    }
