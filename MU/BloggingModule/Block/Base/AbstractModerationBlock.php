...
abstract class AbstractModerationBlock extends AbstractBlockHandler
{
    ...
    {
        return $this->__('Blogging moderation', 'mubloggingmodule');
    }
    ...
    public function display(array $properties = [])
    {
        ...
        if (!$this->hasPermission('MUBloggingModule:ModerationBlock:', "$properties[title]::", ACCESS_OVERVIEW)) {
            return '';
        }
        ...
        if (empty($properties['title'])) {
            $properties['title'] = $this->__('Moderation', 'mubloggingmodule');
        }
    ...
    {
        return '@MUBloggingModule/Block/moderation.html.twig';
    }
}
