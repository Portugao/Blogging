...
namespace MU\BloggingModule\Twig\Base;
...
abstract class AbstractTwigExtension extends Twig_Extension
{
    ...
    /**
     * The mubloggingmodule_objectState filter displays the name of a given object's workflow state.
     * Examples:
     *    {{ item.workflowState|mubloggingmodule_objectState }}        {# with visual feedback #}
     *    {{ item.workflowState|mubloggingmodule_objectState(false) }} {# no ui feedback #}
     *
    ...
    /**
     * The mubloggingmodule_fileSize filter displays the size of a given file in a readable way.
     * Example:
     *     {{ 12345|mubloggingmodule_fileSize }}
     *
    ...
    /**
     * The mubloggingmodule_listEntry filter displays the name
     * or names for a given list item.
     * Example:
     *     {{ entity.listField|mubloggingmodule_listEntry('entityName', 'fieldName') }}
     *
    ...
    public function getListEntry($value, $objectType = '', $fieldName = '', $delimiter = ', ')
    {
        ...
        $this->translator->setDomain('mubloggingmodule');
    ...
    /**
     * The mubloggingmodule_moderationObjects function determines the amount of unapproved objects.
    ...
    /**
     * The mubloggingmodule_objectTypeSelector function provides items for a dropdown selector.
     *
     * @return string The output of the plugin
     */
    ...
    /**
     * The mubloggingmodule_templateSelector function provides items for a dropdown selector.
     *
     * @return string The output of the plugin
     */
