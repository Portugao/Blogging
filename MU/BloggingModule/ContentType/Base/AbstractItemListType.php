...
use MU\BloggingModule\ContentType\Form\Type\ItemListType as FormType;
...
abstract class AbstractItemListType extends AbstractContentType
{
    ...
    {
        return $this->translator->__('Blogging list', 'mubloggingmodule');
    }
    ...
    {
        return $this->translator->__('Display a list of blogging objects.', 'mubloggingmodule');
    }
    ...
    public function getViewTemplatePath($suffix = '')
    {
        ...
        foreach ($templateOptions as $templatePath) {
            if ($this->twigLoader->exists('@MUBloggingModule/' . $templatePath)) {
