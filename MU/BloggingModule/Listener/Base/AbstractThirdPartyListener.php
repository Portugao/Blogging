...
abstract class AbstractThirdPartyListener implements EventSubscriberInterface
{
    ...
    public function getEditorHelpers(\Zikula_Event $event)
    {
        ...
        $helpers->add(
            [
                ...
                'type'   => 'javascript',
                'path'   => 'modules/MU/BloggingModule/Resources/public/js/MUBloggingModule.Finder.js'
            ]
        );
    }
    ...
    public function getTinyMcePlugins(\Zikula_Event $event)
    {
        ...
        $plugins->add(
            [
                ...
                'path' => 'modules/MU/BloggingModule/Resources/docs/scribite/plugins/TinyMce/vendor/tinymce/plugins/mubloggingmodule/plugin.js'
            ]
        );
    }
    ...
    public function getCKEditorPlugins(\Zikula_Event $event)
    {
        ...
        $plugins->add(
            [
                'name' => 'mubloggingmodule',
                'path' => 'modules/MU/BloggingModule/Resources/docs/scribite/plugins/CKEditor/vendor/ckeditor/plugins/mubloggingmodule/',
                'file' => 'plugin.js',
