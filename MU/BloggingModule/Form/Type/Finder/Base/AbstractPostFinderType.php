...
namespace MU\BloggingModule\Form\Type\Finder\Base;
...
/**
 * Post finder form type base class.
 */
abstract class AbstractPostFinderType extends AbstractType
{
    use TranslatorTrait;
    ...
    public function addPasteAsField(FormBuilderInterface $builder, array $options)
    {
        $builder->add('pasteAs', ChoiceType::class, [
            ...
            'empty_data' => 1,
            'choices' => [
                $this->__('Relative link to the post') => 1,
                $this->__('Absolute url to the post') => 2,
                $this->__('ID of post') => 3,
                $this->__('Relative link to the image') => 6,
                $this->__('Image') => 7,
                $this->__('Image with relative link to the post') => 8,
                $this->__('Image with absolute url to the post') => 9
            ],
    ...
    {
        return 'mubloggingmodule_postfinder';
    }
