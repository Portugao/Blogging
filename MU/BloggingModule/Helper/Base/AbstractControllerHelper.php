...
abstract class AbstractControllerHelper
{
    ...
    public function processViewActionParameters($objectType, SortableColumns $sortableColumns, array $templateParameters = [], $supportsHooks = false)
    {
        ...
        $templateParameters['own'] = $request->query->getInt('own', $this->variableApi->get('MUBloggingModule', 'showOnlyOwnEntries', 0));
        ...
        if (true === $supportsHooks) {
            ...
            $templateParameters['currentUrlObject'] = new RouteUrl('mubloggingmodule_' . $objectType . '_' . /*$templateParameters['routeArea'] . */'view', $urlParameters);
        }
    ...
    public function processDisplayActionParameters($objectType, array $templateParameters = [], $supportsHooks = false)
    {
        ...
        if (true === $supportsHooks) {
            ...
            $templateParameters['currentUrlObject'] = new RouteUrl('mubloggingmodule_' . $objectType . '_' . /*$templateParameters['routeArea'] . */'display', $urlParameters);
        }
    ...
    public function addTemplateParameters($objectType = '', array $parameters = [], $context = '', array $args = [])
    {
        ...
        if ($context == 'controllerAction') {
            ...
            if ($objectType == 'post') {
                $thumbRuntimeOptions = [];
                $thumbRuntimeOptions[$objectType . 'ImageForArticle'] = $this->imageHelper->getRuntimeOptions($objectType, 'imageForArticle', $context, $args);
            ...
            if (in_array($args['action'], ['display', 'edit', 'view'])) {
                ...
                $parameters['relationThumbRuntimeOptions'] = $this->imageHelper->getCustomRuntimeOptions('', '', 'MUBloggingModule_relateditem', $context, $args);
            }
        }
