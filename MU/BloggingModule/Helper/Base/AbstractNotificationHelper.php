...
abstract class AbstractNotificationHelper
{
    ...
    protected function collectRecipients()
    {
        ...
        if ($this->recipientType == 'moderator' || $this->recipientType == 'superModerator') {
            ...
            $moderatorGroupId = $this->variableApi->get('MUBloggingModule', 'moderationGroupFor' . $modVarSuffix, 2);
            if ($this->recipientType == 'superModerator') {
                $moderatorGroupId = $this->variableApi->get('MUBloggingModule', 'superModerationGroupFor' . $modVarSuffix, 2);
            }
    ...
    protected function sendMails()
    {
        ...
        foreach ($this->recipients as $recipient) {
            ...
            $body = $this->templating->render('@MUBloggingModule/' . $template, $templateParameters);
            $altBody = '';
            $html = true;
