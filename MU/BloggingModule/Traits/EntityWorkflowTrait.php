...
namespace MU\BloggingModule\Traits;
...
trait EntityWorkflowTrait
{
    ...
    {
        $entityClass = 'MUBloggingModule:' . ucfirst($this->get_objectType()) . 'Entity';
    ...
    public function initWorkflow($forceLoading = false)
    {
        ...
        $workflowHelper = $container->get('mu_blogging_module.workflow_helper');
        ...
        if (($loadingRequired && !$isReuse) || $forceLoading) {
            $result = Zikula_Workflow_Util::getWorkflowForObject($this, $objectType, $idColumn, 'MUBloggingModule');
            if (!$result) {
    ...
    public function resetWorkflow()
    {
        ...
        $workflowHelper = ServiceUtil::get('mu_blogging_module.workflow_helper');
