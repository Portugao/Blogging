...
namespace MU\BloggingModule\Entity\Repository\Base;
 ...
 */
abstract class AbstractImageRepository extends EntityRepository
{
    ...
    public function truncateTable(LoggerInterface $logger)
    {
        ...
        $qb->delete('MU\BloggingModule\Entity\ImageEntity', 'tbl');
        $query = $qb->getQuery();
    
        $query->execute();
    
        $logArgs = ['app' => 'MUBloggingModule', 'entity' => 'image'];
    ...
    public function updateCreator($userId, $newUserId, TranslatorInterface $translator, LoggerInterface $logger, CurrentUserApi $currentUserApi)
    {
        ...
        $qb = $this->getEntityManager()->createQueryBuilder();
        $qb->update('MU\BloggingModule\Entity\ImageEntity', 'tbl')
        ...
        $logArgs = ['app' => 'MUBloggingModule', 'user' => $currentUserApi->get('uname'), 'entities' => 'images', 'userid' => $userId];
    ...
    protected function getCountQuery($where = '', $useJoins = false)
    {
        ...
        $qb = $this->getEntityManager()->createQueryBuilder();
        $qb->select($selection)
           ->from('MU\BloggingModule\Entity\ImageEntity', 'tbl');
    ...
    public function getQueryFromBuilder(QueryBuilder $qb)
    {
        ...
        if ($featureActivationHelper->isEnabled(FeatureActivationHelper::TRANSLATIONS, 'image')) {
