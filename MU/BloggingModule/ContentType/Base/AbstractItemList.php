...
namespace MU\BloggingModule\ContentType\Base;
...
abstract class AbstractItemList extends \Content_AbstractContentType implements ContainerAwareInterface
{
    ...
    {
        return $this->container->get('translator.default')->__('MUBloggingModule list view');
    }
    ...
    {
        return $this->container->get('translator.default')->__('Display list of MUBloggingModule objects.');
    }
    ...
    {
        $controllerHelper = $this->container->get('mu_blogging_module.controller_helper');
        ...
        $featureActivationHelper = $this->container->get('mu_blogging_module.feature_activation_helper');
        if ($featureActivationHelper->isEnabled(FeatureActivationHelper::CATEGORIES, $this->objectType)) {
            $this->categorisableObjectTypes = ['post'];
            $categoryHelper = $this->container->get('mu_blogging_module.category_helper');
    ...
    {
        $repository = $this->container->get('mu_blogging_module.entity_factory')->getRepository($this->objectType);
        $permissionApi = $this->container->get('zikula_permissions_module.api.permission');
    
        // create query
        $orderBy = $this->container->get('mu_blogging_module.model_helper')->resolveSortParameter($this->objectType, $this->sorting);
        ...
        $templateParameters = $this->container->get('mu_blogging_module.controller_helper')->addTemplateParameters($this->objectType, $templateParameters, 'contentType', []);
    ...
    protected function getDisplayTemplate()
    {
        ...
        foreach ($templateOptions as $templatePath) {
            if ($templating->exists('@MUBloggingModule/' . $templatePath)) {
                $template = '@MUBloggingModule/' . $templatePath;
                break;
            }
        }
    ...
    public function startEditing()
    {
        ...
        $this->view->toplevelmodule = 'MUBloggingModule';
    
        // ensure our custom plugins are loaded
        array_push($this->view->plugins_dir, 'modules/MU/BloggingModule/Resources/views/plugins');
        ...
        if ($featureActivationHelper->isEnabled(FeatureActivationHelper::CATEGORIES, $this->objectType)) {
            ...
            $this->view->assign('categories', $categories)
                       ->assign('categoryHelper', $this->container->get('mu_blogging_module.category_helper'));
        }
