...
abstract class AbstractViewHelper
{
    ...
    public function getViewTemplate($type, $func)
    {
        ...
        $template = '@MUBloggingModule/' . ucfirst($type) . '/' . $func;
    ...
    {
        $extensions = [];
        $hasAdminAccess = $this->permissionApi->hasPermission('MUBloggingModule:' . ucfirst($type) . ':', '::', ACCESS_ADMIN);
        if ($func == 'view') {
            if ($hasAdminAccess) {
                $extensions = ['rss'];
            } else {
    ...
    protected function processPdf(array $templateParameters = [], $template)
    {
        ...
        $output = $this->twig->render('@MUBloggingModule/includePdfHeader.html.twig') . $output . '</body></html>';
