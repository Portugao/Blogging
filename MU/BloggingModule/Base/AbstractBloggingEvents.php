...
abstract class AbstractBloggingEvents
{
    ...
    /**
     * The mubloggingmodule.image_post_load event is thrown when images
     * are loaded from the database.
     *
     * The event listener receives an
     * MU\BloggingModule\Event\FilterImageEvent instance.
     *
     * @see MU\BloggingModule\Listener\EntityLifecycleListener::postLoad()
     * @var string
     */
    const IMAGE_POST_LOAD = 'mubloggingmodule.image_post_load';
    
    /**
     * The mubloggingmodule.image_pre_persist event is thrown before a new image
     * is created in the system.
     *
     * The event listener receives an
     * MU\BloggingModule\Event\FilterImageEvent instance.
     ...
     * @var string
     */
    const IMAGE_PRE_PERSIST = 'mubloggingmodule.image_pre_persist';
    
    /**
     * The mubloggingmodule.image_post_persist event is thrown after a new image
     * has been created in the system.
     *
     * The event listener receives an
     * MU\BloggingModule\Event\FilterImageEvent instance.
     ...
     * @var string
     */
    const IMAGE_POST_PERSIST = 'mubloggingmodule.image_post_persist';
    
    /**
     * The mubloggingmodule.image_pre_remove event is thrown before an existing image
     * is removed from the system.
     *
     * The event listener receives an
     * MU\BloggingModule\Event\FilterImageEvent instance.
     ...
     * @var string
     */
    const IMAGE_PRE_REMOVE = 'mubloggingmodule.image_pre_remove';
    
    /**
     * The mubloggingmodule.image_post_remove event is thrown after an existing image
     * has been removed from the system.
     *
     * The event listener receives an
     * MU\BloggingModule\Event\FilterImageEvent instance.
     ...
     * @var string
     */
    const IMAGE_POST_REMOVE = 'mubloggingmodule.image_post_remove';
    
    /**
     * The mubloggingmodule.image_pre_update event is thrown before an existing image
     * is updated in the system.
     *
     * The event listener receives an
     * MU\BloggingModule\Event\FilterImageEvent instance.
     ...
     * @var string
     */
    const IMAGE_PRE_UPDATE = 'mubloggingmodule.image_pre_update';
    
    /**
     * The mubloggingmodule.image_post_update event is thrown after an existing new image
     * has been updated in the system.
     *
     * The event listener receives an
     * MU\BloggingModule\Event\FilterImageEvent instance.
     ...
     * @var string
     */
    const IMAGE_POST_UPDATE = 'mubloggingmodule.image_post_update';
