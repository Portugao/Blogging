...
use MU\BloggingModule\ContentType\Form\Type\ItemType as FormType;
...
abstract class AbstractItemType extends AbstractContentType
{
    ...
    {
        return $this->translator->__('Blogging detail', 'mubloggingmodule');
    }
    ...
    {
        return $this->translator->__('Display or link a single blogging object.', 'mubloggingmodule');
    }
    ...
    public function displayView()
    {
        ...
        $controllerReference = new ControllerReference('MUBloggingModule:External:display', $this->getDisplayArguments(), ['template' => $this->data['customTemplate']]);
    ...
    {
        if (null === $this->data['id'] || empty($this->data['id']) || empty($this->data['displayMode'])) {
            return $this->translator->__('No item selected.', 'mubloggingmodule');
        }
