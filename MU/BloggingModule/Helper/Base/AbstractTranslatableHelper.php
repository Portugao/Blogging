...
abstract class AbstractTranslatableHelper
{
    ...
    public function getTranslatableFields($objectType)
    {
        ...
        switch ($objectType) {
            case 'post':
                $fields = ['title', 'permalink', 'descriptionForGoogle', 'textForSimilar', 'textForRelevant', 'descriptionOfImageForArticle', 'summaryOfPost', 'content', 'content2', 'advertising', 'content3', 'content4', 'advertising2', 'content5', 'content6', 'advertising3', 'slug'];
                break;
        }
    ...
    public function prepareEntityForEditing($entity)
    {
        ...
        $repository = $entityManager->getRepository('MU\BloggingModule\Entity\\' . ucfirst($objectType) . 'TranslationEntity');
