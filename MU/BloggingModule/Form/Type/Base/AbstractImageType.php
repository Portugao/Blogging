    ...
    public function addEntityFields(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('title', 'Symfony\Component\Form\Extension\Core\Type\TextType', [
            ...
            'attr' => [
                'maxlength' => 255,
                'class' => '',
                'title' => $this->__('Enter the title of the image')
            ],
            'required' => true,
        ]);
        ...
        $builder->add('description', 'Symfony\Component\Form\Extension\Core\Type\TextType', [
            ...
            'attr' => [
                'maxlength' => 255,
                'class' => '',
                'title' => $this->__('Enter the description of the image')
            ],
            'required' => false,
        ]);
        
        if ($this->variableApi->getSystemVar('multilingual') && $this->featureActivationHelper->isEnabled(FeatureActivationHelper::TRANSLATIONS, 'image')) {
            $supportedLanguages = $this->translatableHelper->getSupportedLanguages('image');
            if (is_array($supportedLanguages) && count($supportedLanguages) > 1) {
                $currentLanguage = $this->translatableHelper->getCurrentLanguage();
                $translatableFields = $this->translatableHelper->getTranslatableFields('image');
                $mandatoryFields = $this->translatableHelper->getMandatoryFields('image');
        ...
        $builder->add('imageForArticle', 'MU\BloggingModule\Form\Type\Field\UploadType', [
            ...
            'attr' => [
                ...
                'title' => $this->__('Enter the image for article of the image')
            ],
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver
            ->setDefaults([
                ...
                'data_class' => 'MU\BloggingModule\Entity\ImageEntity',
