...
namespace MU\BloggingModule\Block\Base;

use Symfony\Component\HttpKernel\Controller\ControllerReference;
use Zikula\BlocksModule\AbstractBlockHandler;
use MU\BloggingModule\Block\Form\Type\ItemBlockType;
...
abstract class AbstractItemBlock extends AbstractBlockHandler
{
    ...
    {
        return $this->__('Blogging detail', 'mubloggingmodule');
    }
    ...
    public function display(array $properties = [])
    {
        ...
        if (!$this->hasPermission('MUBloggingModule:ItemBlock:', "$properties[title]::", ACCESS_OVERVIEW)) {
            return '';
        }
        ...
        $controllerReference = new ControllerReference('MUBloggingModule:External:display', $this->getDisplayArguments($properties), ['template' => $properties['customTemplate']]);
    ...
    {
        return '@MUBloggingModule/Block/item_modify.html.twig';
    }
