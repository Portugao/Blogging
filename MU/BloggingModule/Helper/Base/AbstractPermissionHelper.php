...
abstract class AbstractPermissionHelper implements ContainerAwareInterface
{
    ...
    public function hasEntityPermission($entity, $permissionLevel, $userId = null)
    {
        ...
        return $this->permissionApi->hasPermission('MUBloggingModule:' . ucfirst($objectType) . ':', $instance, $permissionLevel, $userId);
    }
    ...
    {
        return $this->permissionApi->hasPermission('MUBloggingModule:' . ucfirst($objectType) . ':', '::', $permissionLevel, $userId);
    }
    ...
    {
        return $this->permissionApi->hasPermission('MUBloggingModule::', '::', $permissionLevel, $userId);
    }
