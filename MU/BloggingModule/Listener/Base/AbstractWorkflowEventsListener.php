...
use MU\BloggingModule\Helper\NotificationHelper;
...
abstract class AbstractWorkflowEventsListener implements EventSubscriberInterface
{
    ...
    public function onGuard(GuardEvent $event)
    {
        ...
        $hasApproval = in_array($objectType, ['post']);
        ...
        if (!$this->permissionApi->hasPermission('MUBloggingModule:' . ucfirst($objectType) . ':', $entity->getKey() . '::', $permissionLevel)) {
