...
namespace MU\BloggingModule\Form\Handler\Image\Base;
...
abstract class AbstractEditHandler extends EditHandler
{
    ...
    protected function createForm()
    {
        ...
        return $this->formFactory->create('MU\BloggingModule\Form\Type\ImageType', $this->entityRef, $options);
    }
    ...
    protected function getRedirectCodes()
    {
        ...
        $codes[] = 'userViewPosts';
        // admin list of posts
        $codes[] = 'adminViewPosts';
        // user list of own posts
        $codes[] = 'userOwnViewPosts';
        // admin list of own posts
        $codes[] = 'adminOwnViewPosts';
        // user detail page of related post
        $codes[] = 'userDisplayPost';
        // admin detail page of related post
        $codes[] = 'adminDisplayPost';
    ...
    public function applyAction(array $args = [])
    {
        ...
        try {
            ...
            $logArgs = ['app' => 'MUBloggingModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => 'image', 'id' => $entity->createCompositeIdentifier(), 'errorMessage' => $e->getMessage()];
    ...
    protected function getRedirectUrl($args)
    {
        ...
        switch ($this->returnTo) {
            ...
            case 'userViewPosts':
            case 'adminViewPosts':
                return $this->router->generate('mubloggingmodule_post_' . $routeArea . 'view');
            case 'userOwnViewPosts':
            case 'adminOwnViewPosts':
                return $this->router->generate('mubloggingmodule_post_' . $routeArea . 'view', [ 'own' => 1 ]);
            case 'userDisplayPost':
            case 'adminDisplayPost':
                if (!empty($this->relationPresets['post'])) {
                    return $this->router->generate('mubloggingmodule_post_' . $routeArea . 'display',  ['id' => $this->relationPresets['post']]);
                }
